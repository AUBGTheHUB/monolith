...
export const ScheduleTabs: React.FC<ScheduleTabsProps> = ({ activeTab }) => (
    <TabsList className="mb-[1.5rem] h-auto p-0 gap-[0.75rem] md:gap-[1rem] lg:gap-[1.625rem] bg-transparent flex flex-wrap justify-center md:justify-start w-full">
        ...
        >
            <TabsTrigger
                value="Friday"
                className="rounded-[calc(0.75rem-3px)] md:rounded-[calc(0.75rem-3.5px)] lg:rounded-[calc(0.75rem-4px)] font-oxanium text-[0.875rem] md:text-[1rem] lg:text-[1.5rem] font-semibold border-0 relative w-[5.5rem] md:w-[6.5rem] lg:w-[8.25rem] h-[2rem] md:h-[2.5rem] lg:h-[3.063rem] flex items-center justify-center"
                style={
                    activeTab === 'Friday'
