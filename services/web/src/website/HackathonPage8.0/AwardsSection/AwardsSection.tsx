    ...
    return (
        ...
        >
            ...
            <div className="w-full flex items-center justify-center mb-28 sm:mb-36 relative z-30 px-8 sm:px-16">
                <div className="flex-1 h-[8px] bg-white" aria-hidden="true"></div>
            ...
            <div className="w-full flex justify-center relative z-10 mb-28 sm:mb-36">
                <div className="flex flex-col sm:flex-row items-center gap-12 sm:gap-20 sm:mr-[72px]">
                    <article className="flex flex-col items-center w-full sm:w-auto order-1 sm:order-1">
                        <div className="relative rounded-[2rem] border-2 border-white overflow-hidden w-[400px] h-[625px] bg-[url('/AwardsSection/2nd.png')] bg-cover bg-center bg-no-repeat shadow-2xl flex flex-col">
                            <div className="pt-6 px-9 pb-5 flex items-center justify-center">
                                <h3 className="text-white text-4xl font-orbitron font-bold text-center">
                                    Second Place
                                </h3>
                            </div>
                            <div className="w-full h-[2px] bg-white" aria-hidden="true"></div>
                    ...
                    <article className="flex flex-col items-center w-full sm:w-auto order-2 sm:order-2">
                        <div className="relative rounded-[2rem] border-2 border-white overflow-hidden w-[500px] h-[750px] bg-[url('/AwardsSection/1st.png')] bg-cover bg-center bg-no-repeat shadow-2xl flex flex-col">
                            <div className="pt-8 px-10 pb-6 flex items-center justify-center">
                                <h3 className="text-white text-6xl font-orbitron font-bold text-center">First Place</h3>
                            </div>
                            <div className="w-full h-[2px] bg-white" aria-hidden="true"></div>
                            <div className="flex-1 flex items-center justify-center">
                    ...
                    <article className="flex flex-col items-center w-full sm:w-auto order-3">
                        <div className="relative rounded-[2rem] border-2 border-white overflow-hidden w-[344px] h-[550px] bg-[url('/AwardsSection/3rd.png')] bg-cover bg-center bg-no-repeat shadow-2xl flex flex-col">
                            <div className="pt-5 px-8 pb-4 flex items-center justify-center">
                                <h3 className="text-white text-3xl font-orbitron font-bold text-center">Third Place</h3>
                            </div>
                            <div className="w-full h-[2px] bg-white" aria-hidden="true"></div>
                            <div className="flex-1 flex items-center justify-center">
            ...
            <div className="flex flex-col items-center w-full relative z-30">
                <div className="flex flex-col sm:flex-row justify-between items-start w-full text-white text-xl sm:text-2xl font-oxanium gap-8 sm:gap-16 mb-10 px-24 sm:px-48 leading-relaxed">
                    ...
                    <div className="flex-1 text-left sm:text-right">
                        ...
                        <p className="leading-relaxed">swag from The Hub and all HackAUBG 8.0 partners!</p>
                    </div>
                </div>
