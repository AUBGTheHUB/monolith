...
export default function JuryModule({ imgSrc, name, job, company }: JuryModule) {
    return (
        <div className="relative min-w-28 max-w-70 max-[1122px]:max-w-full h-96 border-[1px] rounded-[6px] border-[#A9B4C3] font-semibold ">
