        ...
        <Fragment>
            {isDesktop ? (
                ...
                <div>
                    ...
                    <div className="relative w-full min-h-[5rem] pt-[4rem]  bg-gradient-to-b from-stone-950/0 from-10% via-hackBg/50 via-25%  to-hackBg to-50% z-20 flex justify-center">
                        <img className="absolute top-[0rem] w-full z-10" src="/public/hackLanding/space.svg"></img>
                        <div className="w-4/5 relative lg:top-[11rem] top-[5rem] inset-x-0 z-20 flex-column ">
                            ...
                            <div className=" text-mont text-[#A9B4C3] lg:py-20 py-10 sm:text-lg">
                                <p>
                                    ...
                                    project idea based on the topic we will reveal during the Opening Ceremony, as well
                                    as pitch your project to a panel of judges. But you won’t be on your own - we will
                                    have a team of experienced mentors on hand to offer guidance and support throughout
                                    the event. Plus, there will be awesome prizes and food to keep you fueled and
                                    motivated!
                                </p>
                                <p className="pt-5 md:pt-2 md:pb-2 lg:pb-30 ">
                                    HackAUBG is more than just a hackathon - it’s a community of innovators,
                                    collaborators, and problem-solvers. We believe that together, we can create a better
                                    future through technology and creativity.
                                </p>
                            </div>
                            <img className="w-full pb-40 lg:pb-[30rem]" src="/public/hackMission/underline.svg"></img>
                        </div>
                    </div>
                </div>
            )}
