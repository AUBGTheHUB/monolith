        ...
        <Fragment>
            {isDesktop ? (
                <div className="relative w-full h-[90%] pb-[40rem] sm:pb-[30rem] md:pb-[25rem] lg:pb-[20rem] xl:pb-[35rem] lg:b-[10rem] xs:pb-[35rem]">
                    <img className="w-full z-0" src="/hackLanding/space.svg"></img>
                    <img className="w-full z-0 block xl:hidden" src="/hackLanding/space.svg"></img>
                    <img className="w-full z-0 block xs:hidden" src="/hackLanding/space.svg"></img>
                    <img
                    ...
                    <div className="w-full z-10 absolute lg:top-[12rem] md:top-[15rem] top-[10rem] inset-x-0 flex justify-center items-center">
                        <img className="lg:w-1/2 w-4/5 z-10" src="/hackLanding/title.svg"></img>
                    </div>
                </div>
            ) : (
                <div>
