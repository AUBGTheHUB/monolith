...
function DesktopJourneyModule({ title, text }: JourneyModule) {
    return (
        <div className="scroll-section text-white">
            <div className="border-2 border-[#233340] rounded-md p-6 bg-[#000912] min-w-[35rem] relative md:min-h-[13rem] md:max-h-[23rem] xxl:min-h-[25rem] xxl:max-h-[25rem]">
                <div className="absolute left-[0.30rem] top-[20%] w-1 h-24 bg-white rounded-lg -translate-x-2"></div>
                <h3 className="text-white text-xl md:text-base  mb-2">{title}</h3>
                <p className="text-[#A9B4C3] md:text-[0.6rem] xxl:text-xl text-xs">{text}</p>
