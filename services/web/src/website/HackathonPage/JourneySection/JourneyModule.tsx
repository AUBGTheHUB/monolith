...
function DesktopJourneyModule({ title, text }: JourneyModule) {
    return (
        <div className="scroll-section text-white">
            <div className="border-2 border-[#233340] rounded-md p-6 bg-[#000912] min-w-[35rem] relative md:min-h-[23rem] md:max-h-[23rem] xxl:min-h-[25rem] xxl:max-h-[25rem]">
                ...
                <p className="text-[#A9B4C3] md:text-base xxl:text-xl text-xs">{text}</p>
