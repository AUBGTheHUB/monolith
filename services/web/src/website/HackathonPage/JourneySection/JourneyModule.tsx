...
function DesktopJourneyModule({ title, text }: JourneyModule) {
    return (
        <div className="scroll-section text-white ">
            <div className="border-2 border-[#233340] rounded-md p-6 bg-[#000912] w-[100vh] relative md:min-h-[15rem] md:max-h-[15rem] xxl:min-h-[25rem] xxl:max-h-[25rem]">
                ...
                <p className="text-[#A9B4C3] md:text-xs xxl:text-lg text-xs">{text}</p>
