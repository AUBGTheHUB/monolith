export default function MissionSection() {
    return (
        <div className="absolute xxl:top-[45rem] xl:top-[30rem]  xs:top-[20rem] lg:top-[20rem] md:top-[30rem] sm:top-[30rem] top-[22rem] w-full lg:min-h-[50rem] min-h-[5rem] pt-[4rem]  bg-gradient-to-b from-stone-950/0 from-10% via-hackBg/50 via-25%  to-hackBg to-50% z-20 flex justify-center">
            <div className="w-4/5 relative lg:top-[11rem] top-[5rem] inset-x-0  flex-column ">
                ...
                <div className=" text-mont text-[#A9B4C3] lg:py-20 py-10 lg:text-[20px] text-[10px] md:text-[13px]">
                    <p>
