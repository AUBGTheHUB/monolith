export default function MissionSection() {
    return (
        <div className="absolute xxl:top-[50rem] xl:top-[50rem]  xs:top-[20rem] lg:top-[50rem] md:top-[54rem] sm:top-[30rem] top-[19rem] w-full lg:min-h-[50rem] min-h-[5rem] pt-[4rem]  bg-gradient-to-b from-stone-950/0 from-10% via-hackBg/50 via-25%  to-hackBg to-50% z-20 flex justify-center">
