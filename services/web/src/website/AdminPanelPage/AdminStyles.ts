...
export const Styles = {
    ...
    glass: {
        ...
        cardHover: 'hover:border-white/20 hover:bg-white/[0.06] transition-all duration-300',
    ...
    actions: {
        primaryButton: cn(
            'text-white font-bold transition-all duration-300 active:scale-[0.98]',
            'shadow-[0_0_20px_rgba(0,178,255,0.3)] hover:shadow-[0_0_30px_rgba(0,178,255,0.6)] hover:opacity-90',
        ),
        secondaryButton: 'text-black bg-white border-white hover:bg-gray-100 transition-colors',
    },
} as const;
