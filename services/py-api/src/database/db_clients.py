...
def mongo_db_client_provider() -> AsyncIOMotorClient:
    ...
    instance. ``fastapi.Depends`` will automatically inject the AsyncIOMotorClient instance into its intended consumers
...
MotorClientDep = Annotated[AsyncIOMotorClient, Depends(mongo_db_client_provider)]
"""FastAPI dependency for automatically injecting an AsyncIOMotorClient instance into consumers"""
