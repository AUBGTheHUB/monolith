...
class HubMembersService:
    ...
    async def get(self, member_id: str) -> Result[HubMember | HubAdmin, HubMemberNotFoundError | Exception]:
    ...
    async def delete(self, member_id: str) -> Result[HubMember | HubAdmin, HubMemberNotFoundError | Exception]:
