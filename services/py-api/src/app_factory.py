...
def create_app() -> FastAPI:
    ...
    participants_verification_service = ParticipantVerificationService(
        hackathon_service=hackathon_service, team_service=team_service
    )
    ...
    http_handlers = HttpHandlersContainer(
        ...
        hackathon_management_handlers=HackathonManagementHandlers(
            hackathon_service=hackathon_service, participant_service=participant_service, team_service=team_service
        ),
