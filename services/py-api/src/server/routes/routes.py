...
from src.server.routes.admin.candidates_form.forms_routes import register_candidates_forms_router
...
class Routes:
    ...
    def register_routes(main_router: APIRouter, http_handlers: HttpHandlersContainer) -> None:
        ...
        candidates_forms_router = register_candidates_forms_router(http_handler=http_handlers.candidates_forms_handlers)
        ...
        main_router.include_router(candidates_forms_router)
