...
from tests.unit_tests.conftest import ParticipantVerificationServiceMock


@pytest.fixture
def verification_handlers(
    participant_verification_service_mock: ParticipantVerificationServiceMock,
) -> VerificationHandlers:
    return VerificationHandlers(cast(ParticipantVerificationService, participant_verification_service_mock))
...
async def test_verify_participant_admin_case_success(
    ...
    jwt_token = JwtUtility.encode_data(data=mock_jwt_admin_user_verification_data)
