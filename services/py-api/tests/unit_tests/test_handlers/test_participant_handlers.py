...
#     mock_admin_participant: AdminParticipantInputData,
...
#
#     # Call the handler
#     result = await participant_handlers.create_participant(response_mock)
#
#     # Check that `register_admin_participant` was awaited once with the expected input_data
#     participant_registration_service_mock.register_admin_participant.assert_awaited_once_with(mock_admin_participant)
#
