!(function (e) {
    ...
    const t = [
        ...
        { id: 'c', scopeName: 'source.c', path: 'c.tmLanguage.json', displayName: 'C', samplePath: 'c.sample' },
        {
            id: 'cadence',
        ...
        { id: 'd', scopeName: 'source.d', path: 'd.tmLanguage.json', displayName: 'D', samplePath: 'd.sample' },
        {
            id: 'dart',
        ...
        { id: 'go', scopeName: 'source.go', path: 'go.tmLanguage.json', displayName: 'Go', samplePath: 'go.sample' },
        {
            id: 'graphql',
        ...
        { id: 'r', scopeName: 'source.r', path: 'r.tmLanguage.json', displayName: 'R', samplePath: 'r.sample' },
        {
            id: 'raku',
        ...
        { id: 'v', scopeName: 'source.v', path: 'v.tmLanguage.json', displayName: 'V', samplePath: 'v.sample' },
        {
            id: 'vb',
                    ...
                    class l {
                        ...
                        findNextMatchSync(e, t, s) {
                            let a = o,
                                n = 0;
                            if (
                                ('number' == typeof s ? (8 & s && (a = !0), (n = s)) : 'boolean' == typeof s && (a = s),
                                'string' == typeof e)
                            ) {
                                e = new c(e);
    ...
    const k = 'undefined' != typeof self && void 0 !== self.WorkerGlobalScope,
        ...
        P = k || (!L && !S);
    let v = 'https://cdn.jsdelivr.net/npm/shiki@0.14.4/',
        j = '';
    const w = 'dist/';
    function C(e) {
        j = e;
            ...
            ((s = {
                ...
                36: (e, t) => {
                    ...
                    Object.defineProperty(t, '__esModule', { value: !0 }),
                        ...
                        ((s = t.EncodedTokenAttributes || (t.EncodedTokenAttributes = {})).toBinaryStr = function (e) {
                            let t = e.toString(2);
                            for (; t.length < 32; ) t = '0' + t;
                            return t;
                        }),
                        (s.print = function (e) {
                            const t = s.getLanguageId(e),
                                ...
                                r = s.getForeground(e),
                                o = s.getBackground(e);
                            console.log({ languageId: t, tokenType: a, fontStyle: n, foreground: r, background: o });
                        }),
                ...
                947: (e, t, s) => {
                    ...
                    class g {
                        constructor(e, t, s, a, n, o, i, c) {
                            if (
                                ...
                                for (const e of Object.keys(n)) {
                                    ...
                                    for (const s of t) this._tokenTypeMatchers.push({ matcher: s.matcher, type: n[e] });
                                }
                        }
                        get themeProvider() {
                        ...
                        _collectInjections() {
                            const e = [],
                                ...
                                s = (e => (e === this._rootScopeName ? this._grammar : this.getExternalGrammar(e)))(t);
                            if (s) {
                    ...
                    class _ {
                        ...
                        getBinaryResult(e, t) {
                            ...
                            for (let e = 0, t = this._binaryTokens.length; e < t; e++) s[e] = this._binaryTokens[e];
                            return s;
                        }
                    }
                    t.LineTokens = _;
                            ...
                            switch (p.kind) {
                                ...
                                case 4:
                                    ...
                                    if (a) {
                                        ...
                                        4 === p.kind
                                            ? s.add(new r(p.scopeName, p.ruleName))
                                            : s.add(new n(p.scopeName));
                            }
                        }
                    }
                    ...
                    function c(e, t, s, n, c, p, m, d) {
                        ...
                        function _() {
                            ...
                            if (m === r.endRuleId) {
                                ...
                                if (((c = c.push(m, n, y, u[0].end === g, null, b, b)), o instanceof r.BeginEndRule)) {
                                    const n = o;
                                    a.DebugFlags.InDebugMode &&
                    ...
                    class h {
                        ...
                        match(e) {
                            ...
                            let t,
                                ...
                                a = e.indexOf('.');
                            return (
                                -1 === a ? ((t = e), (s = '')) : ((t = e.substring(0, a)), (s = e.substring(a + 1))),
                        ...
                        _doInsertHere(e, t, s, n, r) {
                            if (null !== t) {
                                for (let o = 0, i = this._rulesWithParentScopes.length; o < i; o++) {
                                    ...
                                    if (0 === a.strArrCmp(i.parentScopes, t)) return void i.acceptOverwrite(e, s, n, r);
                                }
    ...
    function K(e) {
        ...
        for (; e.length > 0; ) {
            ...
            if (!Number.isNaN(a))
                ...
                } else if (a <= 37) t.push({ type: 'setForegroundColor', value: { type: 'named', name: q[a - 30] } });
                else if (38 === a) {
                    const s = V(e);
    ...
    function X(e, t) {
        const a = t.split(/\r?\n/),
            n = Q(Object.fromEntries(q.map(t => [t, e.colors[`terminal.ansi${t[0].toUpperCase()}${t.substring(1)}`]]))),
            r = (function () {
                let e = null,
                    t = null,
                    s = new Set();
    ...
    const Y = {
        pre: ({ className: e, style: t, children: s }) => `<pre class="${e}" style="${t}" tabindex="0">${s}</pre>`,
    ...
    function Z(e, t = {}) {
        ...
        return o('pre', { className: 'shiki ' + (t.themeName || ''), style: `background-color: ${a}` }, [
    ...
    class te extends F.Registry {
        ...
        async loadTheme(e) {
            return 'string' == typeof e
                ? (this._resolvedThemes[e] || (this._resolvedThemes[e] = await R(`${this.themesPath}${e}.json`)),
    ...
    (e.BUNDLED_LANGUAGES = t),
        ...
        (e.getHighlighter = async function (e) {
            const {
                ...
                l = new te(c);
            e.paths?.themes && (l.themesPath = e.paths.themes.endsWith('/') ? e.paths.themes : e.paths.themes + '/'),
                e.paths?.languages &&
                    (c.languagesPath = e.paths.languages.endsWith('/') ? e.paths.languages : e.paths.languages + '/');
