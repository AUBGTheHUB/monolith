...
const RegistrationForm = () => {
    ...
    if (featureSwitches.regForm) {
        if (isApiUp && (!featureSwitches.isRegFull || teamName)) {
            return (
                    ...
                    <div className={styles.form_container}>
                        ...
                        <div className={styles.form_row}>
                            <InputComponent
                                ...
                                error={
                                    errors.has_participated_in_hackaubg && errors.has_participated_in_hackaubg.message
                                }
                            />
                            <InputComponent
                        ...
                        <div className={styles.form_row}>
                            <InputComponent
                                ...
                                error={
                                    errors.has_participated_in_hackathons &&
                                    errors.has_participated_in_hackathons.message
                                }
                            />
                            <InputComponent
                                ...
                                error={
                                    errors.has_previous_coding_experience &&
                                    errors.has_previous_coding_experience.message
                                }
                            />
                        </div>
                    </div>
