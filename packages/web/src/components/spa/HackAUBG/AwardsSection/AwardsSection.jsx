        ...
        <div className="awards-section-container">
            ...
            <div className="awards-images-container">
                <div className="awards-pic-text">
                    <img src="awardIconSilver.png" alt="Silver award badge" id="silver-img"></img>
                    <p className="award-money" id="silver-money-amt">
                        2000 BGN
                    </p>
                </div>
                <div className="awards-pic-text">
                    <img src="awardIconGold.png" alt="Gold award badge" id="gold-img"></img>
                    <p className="award-money" id="gold-money-amt">
                        3000 BGN
                    </p>
                </div>
                <div className="awards-pic-text">
                    <img src="awardIconBronze.png" alt="Bronze award badge" id="bronze-img"></img>
