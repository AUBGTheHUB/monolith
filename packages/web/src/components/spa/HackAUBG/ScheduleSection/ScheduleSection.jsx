    ...
    return (
        ...
        >
            ...
            <div className="schedule-container-hack-aubg">
                <div className="schedule-table-container-hack-aubg">
                ...
                <div className="schedule-table-container-hack-aubg">
                    ...
                    <div className="schedule-table-row-hack-aubg">
                        ...
                        <p className="schedule-event-title-hack-aubg">Dinner</p>
                    </div>
                    <div className="schedule-table-row-hack-aubg">
                        <h2 className="schedule-time-hack-aubg">20:30</h2>
                        <p className="schedule-event-title-hack-aubg">Coding</p>
                    </div>
                </div>
                <div className="schedule-table-container-hack-aubg">
                    ...
                    <div className="schedule-table-row-hack-aubg">
                        <h2 className="schedule-time-hack-aubg">13:00</h2>
                        <p className="schedule-event-title-hack-aubg">Lunch</p>
                    </div>
                    <div className="schedule-table-row-hack-aubg">
                        <h2 className="schedule-time-hack-aubg">14:30</h2>
                        <p className="schedule-event-title-hack-aubg">
